  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CreateBloc, CreateState>(
      listener: (context, state) {
        ...
        } else if(state is Createfoto_shareErrorState){
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text("Error al guardar la foto_share"))
          );
            ...
            children: [
              ...
              MaterialButton(
                ...
                onPressed: () {
                  ...
                  Map<String, dynamic> foto_shareData = {
                    "title" : _titleC.value.text,
                    "public":_defaultSwitchValue,
                  };

                  BlocProvider.of<CreateBloc>(context).add(OnCreateSaveDataEvent(dataToSave: foto_shareData));
                },
              )
            ],
          ),
