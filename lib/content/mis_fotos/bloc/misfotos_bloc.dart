...
class MisfotosBloc extends Bloc<MisfotosEvent, MisfotosState> {
  ...
  FutureOr<void> _saveEditData(OnEditSaveDataEvent event, Emitter emit) async{
    ...
    bool _edited = await _saveEditfoto_share(event.dataToSaveEdit);
  ...
  Future<bool>_saveEditfoto_share(Map<String, dynamic> dataToSaveEdit) async {
    
    try{
      var docRef = await FirebaseFirestore.instance.collection("foto_share");
