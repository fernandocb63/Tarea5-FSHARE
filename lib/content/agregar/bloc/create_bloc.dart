...
class CreateBloc extends Bloc<CreateEvent, CreateState> {
  ...
  FutureOr<void> _saveData(OnCreateSaveDataEvent event, Emitter emit) async {
    ...
    bool _saved = await _savefoto_share(event.dataToSave);
  ...
  Future<bool> _savefoto_share(Map<String, dynamic> dataToSave) async {
    try{
  ...
  Future<String> _uploadPictureToStorage() async {
    try{
      ...
      .ref("foto_share/imagen_${stamp}.png")
      .putFile(_selectedPicture!);

      await task;

      String resultTask = await task.storage.ref("foto_share/imagen_${stamp}.png").getDownloadURL();
  ...
  Future<bool> _updateUserDocumentReference(String foto_sharedId) async {
    try{
